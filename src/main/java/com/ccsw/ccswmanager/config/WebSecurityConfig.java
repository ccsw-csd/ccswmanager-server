...
import com.ccsw.ccswmanager.config.security.JsonWebTokenAuthenticationFilter;
import com.ccsw.ccswmanager.config.security.JsonWebTokenAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void setupAuthorization(HttpSecurity http) throws Exception {
        ...
        String[] unsecuredResources = new String[] { "/", "/public/**", "/health", "/actuator/**", "/photo/**" };
